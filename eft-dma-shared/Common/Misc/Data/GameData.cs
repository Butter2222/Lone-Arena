...
namespace eft_dma_shared.Common.Misc.Data
{
    ...
    public static class GameData
    {
        ...
        public static FrozenDictionary<string, string> BossNames { get; } = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["Коллонтай"] = "Kollontay",
            ["Дед Мороз"] = "Santa",
            ["Santa Claus"] = "Santa",
            ...
            ["Кабан"] = "Kaban",
            ["Партизан"] = "Partisan",
            ["Призрак"] = "Ghost", // Halloween 2024
            ["Они"] = "Oni", // Halloween 2024
            ["Предвестник"] = "Harbinger" // Halloween 2024

        }.ToFrozenDictionary(StringComparer.OrdinalIgnoreCase);

        public static FrozenDictionary<string, string> RaiderNames { get; } = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["Сектант"] = "Cultist",
            ["Питон"] = "Raider",
            ["Медведь"] = "Raider",
